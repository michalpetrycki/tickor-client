...
export class ClientService {
  ...
  public list(filters?: ClientListFilter): Observable<ClientResponse[]> {
    ...
    return this.apiService.request(clientListRequest);
  }

  public listPaginated(paginate: Pagination, filters?: ClientListFilter): Observable<PaginatedResponse<ClientResponse>> {
    const clientListRequest = new ClientListRequest(filters);
    clientListRequest.paginate = paginate;
    return this.apiService.requestPaginated(clientListRequest);
  }

  public create(properties: ClientCreateProperties): Observable<ClientResponse | undefined> {
    const clientCreateProperties = new ClientCreateRequest(properties);
    return this.apiService.requestFirstResult(clientCreateProperties);
  }
  ...
  public edit(properties: ClientEditProperties): Observable<ClientResponse | undefined> {
    ...
    return this.apiService.requestFirstResult(clientEditProperties);
  }
